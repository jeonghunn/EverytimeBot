...
tf.app.flags.DEFINE_string("train_candidate_dir", "./modelc", "학습후보 저장할 폴더")
...
tf.app.flags.DEFINE_boolean("data_loop", False, "작은 데이터셋을 실험해보기 위해 사용합니다.")
...
tf.app.flags.DEFINE_string("voc_candidate_path", "./data/chatc.voc", "어휘 사전 후보 파일 위치")
